...
class Pokemon {
	...
	protected:
		enum {ITEM = 0, MOVES = 4, MAX_MOVES = 5, TYPES = 5};
		enum {electric, fire, water, grass, normal} type;
		enum {alive, ko} status;
		bool grown;
		int level;
		int exp;
		int hp;
	...
	public:
		...
		Pokemon(AddOnsDb*, mstr);//arg constructor takes pointer to database
		...
		bool learn(const mstr &);//helper function takes a string indicating type
		...
		void changeName(const mstr &);//set new name
		...
		friend bool operator== (const Pokemon &, const mstr &);//== operator overload
		friend bool operator== (const mstr &, const Pokemon &);//== operator overload
		friend bool operator!= (const Pokemon &, const Pokemon &);//!= operator overload
		friend bool operator!= (const Pokemon &, const mstr &);//!= operator overload
		friend bool operator!= (const mstr &, const Pokemon &);//!= operator overload
		friend bool operator<= (const Pokemon &, const Pokemon &);//<= operator overload
...
class Pikachu : public Pokemon {
	...
	public:
		...
		explicit Pikachu(AddOnsDb*, mstr = "Pikachu");//arg constructor
...
class Charmander : public Pokemon {
	...
	public:
		...
		explicit Charmander(AddOnsDb*, mstr = "Charmander");//arg constructor
...
class Squirtle : public Pokemon {
	...
	public:
		...
		explicit Squirtle(AddOnsDb*, mstr = "Squirtle");//arg constructor
...
class Bulbasaur : public Pokemon {
	...
	public:
		...
		explicit Bulbasaur(AddOnsDb*, mstr = "Bulbasaur");//arg constructor
